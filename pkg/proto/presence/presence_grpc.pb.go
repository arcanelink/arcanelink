...
const (
	...
	PresenceService_GetMultiplePresence_FullMethodName = "/presence.PresenceService/GetMultiplePresence"
)
...
type PresenceServiceClient interface {
	...
	GetMultiplePresence(ctx context.Context, in *GetMultiplePresenceRequest, opts ...grpc.CallOption) (*GetMultiplePresenceResponse, error)
}
...
func (c *presenceServiceClient) GetMultiplePresence(ctx context.Context, in *GetMultiplePresenceRequest, opts ...grpc.CallOption) (*GetMultiplePresenceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMultiplePresenceResponse)
	err := c.cc.Invoke(ctx, PresenceService_GetMultiplePresence_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PresenceServiceServer interface {
	...
	GetMultiplePresence(context.Context, *GetMultiplePresenceRequest) (*GetMultiplePresenceResponse, error)
...
func (UnimplementedPresenceServiceServer) GetMultiplePresence(context.Context, *GetMultiplePresenceRequest) (*GetMultiplePresenceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMultiplePresence not implemented")
}
...
func _PresenceService_GetMultiplePresence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMultiplePresenceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PresenceServiceServer).GetMultiplePresence(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PresenceService_GetMultiplePresence_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PresenceServiceServer).GetMultiplePresence(ctx, req.(*GetMultiplePresenceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PresenceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMultiplePresence",
			Handler:    _PresenceService_GetMultiplePresence_Handler,
		},
	},
